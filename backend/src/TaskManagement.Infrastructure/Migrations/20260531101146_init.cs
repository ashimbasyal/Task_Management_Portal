        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanViewAllDepartments = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GitLabLink = table.Column<string>(type: "text", nullable: true),
                    Remarks = table.Column<string>(type: "text", nullable: true),
                    PriorityId = table.Column<int>(type: "integer", nullable: true),
                    StatusId = table.Column<int>(type: "integer", nullable: true),
                    DepartmentId = table.Column<int>(type: "integer", nullable: true),
                    IsMovedToSprint = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BacklogTasks_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    BacklogTaskId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BacklogTasks_DepartmentId",
                table: "BacklogTasks",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_BacklogTasks_PriorityId",
                table: "BacklogTasks",
                column: "PriorityId");

            migrationBuilder.CreateIndex(
                name: "IX_BacklogTasks_StatusId",
                table: "BacklogTasks",
                column: "StatusId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SprintTasks_BacklogTaskId",
                table: "SprintTasks",
